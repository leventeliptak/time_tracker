...
import com.example.levi.time_tracker.network.NetworkModule;
...
public class MockNetworkModule {
	...
	@Provides
	@Singleton
	public TimeTrackerApi provideAuthApi(Retrofit retrofit) {
		return networkModule.provideATimeTrackerApi(retrofit);
	}
